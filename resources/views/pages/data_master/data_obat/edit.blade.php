...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-body">
                <form class="mx-3 mb-5 mt-5" id="quickForm" method="POST" action="{{ url('obat/' . $obat->id) }}">
                    @csrf
                    <input type="hidden" name="_method" value="PATCH">
                    <div class="form-group">
                        <p>Kode Obat</p>
                        <input type="text" name="kode_obat" value="{{ $obat->kode_obat }}"
                            class="form-control @error('kode_obat') is-invalid @enderror" id="kode_obat" required readonly>
                        @error('kode_obat')
