...
@section('content')
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-body">
                <form class="mx-3 mb-5 mt-5" id="quickForm" method="POST" action="{{ url('tindakan/' . $tindakan->id) }}">
                    @csrf
                    ...
                    <div class="form-group">
                        <p>Nama Tindakan</p>
                        <input type="text" name="nama_tindakan" value="{{ $tindakan->nama_tindakan }}"
                    ...
                    <div class="form-group">
                        <p>Harga</p>
                        <input type="number" name="harga" value="{{ $tindakan->harga }}"
