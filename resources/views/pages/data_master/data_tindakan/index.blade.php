    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="table-responsive mx-4 mb-5 mt-4">
                <div class="row">
                    <div class="col-4">
                        <a class="btn btn-success" href="{{ url('tindakan/create') }}"><i class="fa fa-plus"></i>
                            Tambah Data</a>
                    </div>
                        ...
                        @foreach ($tindakans as $key => $value)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-info btn-sm" href="{{ url('tindakan/' . $value->id) }}"><i
                                            class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn btn-success btn-sm"
                                        href="{{ url('tindakan/' . $value->id . '/edit') }}">
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "delete_tindakan/" + userid + ""
